...
class TestApiMercadoBitcoin:
    ...
    def test_get_data_response_success(self, mock_get_endpoint, mock_requests, fixture_api):
    ...
    def test_get_data_response_failure(self, mock_get_endpoint, mock_requests, fixture_api):
